"""
Visualization of Real GDP Evolution (Absolute Values)
...
ax.plot(bau_data['Year'], bau_data['Real_GDP_Total_Billion_EUR'],
        color='#2E86AB', linewidth=2.5, label='BAU')
ax.plot(ets1_data['Year'], ets1_data['Real_GDP_Total_Billion_EUR'],
        color='#C75146', linewidth=2.5, label='ETS1')
ax.plot(ets2_data['Year'], ets2_data['Real_GDP_Total_Billion_EUR'],
        color='#E8A13A', linewidth=2.5, label='ETS2')
...
ax.set_ylabel('Real GDP (Billion EUR)', fontsize=13, fontweight='normal')
...
png_path = output_dir / 'GDP_Absolute_Values.png'
pdf_path = output_dir / 'GDP_Absolute_Values.pdf'
